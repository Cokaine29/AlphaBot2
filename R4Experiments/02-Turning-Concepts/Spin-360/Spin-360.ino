/*
   Experiment 02: Spin-360 (R4 WiFi - WiFi/OTA Disabled)
...
const unsigned long SPIN_DURATION_MS = 900; // Estimated baseline
const int SPIN_SPEED = 60;                  // Fixed spinning speed

void setup() {
  Serial.begin(115200);
  delay(1000);
  Serial.println("Starting Spin 360 Setup (Wi-Fi/OTA Disabled)...");
...
void loop() {
  // Spin clockwise
  Serial.println("Executing 360 spin...");
