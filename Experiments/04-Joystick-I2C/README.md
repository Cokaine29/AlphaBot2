...
* **[04-Joystick-I2C.ino](file:///f:/AlphaBot2/Experiments/04-Joystick-I2C/04-Joystick-I2C.ino)**: Read joystick buttons over I2C, output status to Serial Monitor, ring the buzzer, and control motor movements and NeoPixel colors.
...
1. Open [04-Joystick-I2C.ino](file:///f:/AlphaBot2/Experiments/04-Joystick-I2C/04-Joystick-I2C.ino) and upload it.
...
4. Check that the NeoPixel LEDs light up:
   * **UP** $\rightarrow$ Green
   * **DOWN** $\rightarrow$ Red
   * **LEFT** $\rightarrow$ Yellow
   * **RIGHT** $\rightarrow$ Blue
   * **CENTER** $\rightarrow$ Cyan (Light Blue)
