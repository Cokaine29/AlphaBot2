...
1. **[03-Speed-Characterization](file:///f:/AlphaBot2/Experiments/03-Speed-Kinematics/03-Speed-Characterization/03-Speed-Characterization.ino)**: Drives the robot forward at a selectable PWM speed for exactly 3.0 seconds. Used to collect calibration data.
2. **[03-Distance-Target](file:///f:/AlphaBot2/Experiments/03-Speed-Kinematics/03-Distance-Target/03-Distance-Target.ino)**: Takes a target distance and PWM speed, computes the required run duration using the student's calibrated speed, drives the robot, and stops.
...
2. Open the [03-Speed-Characterization](file:///f:/AlphaBot2/Experiments/03-Speed-Kinematics/03-Speed-Characterization/03-Speed-Characterization.ino) sketch.
3. In the sketch, set `TEST_PWM = 80`. Upload the code to the robot.
...
1. Open the [03-Distance-Target](file:///f:/AlphaBot2/Experiments/03-Speed-Kinematics/03-Distance-Target/03-Distance-Target.ino) sketch.
