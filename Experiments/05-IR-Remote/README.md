...
* **[05-IR-Remote.ino](file:///f:/AlphaBot2/Experiments/05-IR-Remote/05-IR-Remote.ino)**: Bit-bang logic reading the IR pin, decoding the NEC frame, verifying integrity, and mapping key presses to motor commands.
...
1. Open [05-IR-Remote.ino](file:///f:/AlphaBot2/Experiments/05-IR-Remote/05-IR-Remote.ino) and upload it.
